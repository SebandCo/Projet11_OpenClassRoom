...
def test_affichage_booking_erreur_club_navigation(mocker, client, club_fixture, competition_fixture):
...
def test_affichage_booking_erreur_competition_navigation(mocker, client, club_fixture, competition_fixture):
